...
CUDA_VISIBLE_DEVICES=3,4,6,9 accelerate launch --mixed_precision=bf16 --multi_gpu \
  --num_machines $NUM_NODES --num_processes $NUM_GPUS src/train_difix.py \
  ...
  --checkpointing_steps=200 --eval_freq=100 --viz_freq=50 \
  --lambda_lpips 1.0 --lambda_l2 1.0 --lambda_gram 0.25 --gram_loss_warmup_steps 300 \
  --gram_crop_size 224 \
  --lpips_net vgg --lpips_downsample 256 --lpips_max_views 1 \
