...
CUDA_VISIBLE_DEVICES=0,6,7,9 accelerate launch --mixed_precision=bf16 --multi_gpu \
  ...
  --checkpointing_steps=2000 --eval_freq=100 --viz_freq=50 \
  --lambda_lpips 1.0 --lambda_l2 1.0 --lambda_gram 0.25 --gram_loss_warmup_steps 1500 \
  --lpips_net vgg \
  --views_per_microbatch 2 \
  --use_8bit_optimizer \
  --freeze_unet \
  --report_to "wandb" --tracker_project_name "difix" --tracker_run_name "train_small_640_2views" \
  --timestep 199